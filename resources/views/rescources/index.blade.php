    ...
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
            <div class="card" id="showNewsPost">
                ...
                <div class="col-md-12 col-md-offset-0">
                    @if ($post->title && Storage::disk('local')->has($post->title . '' . $post->user_id . 'commu.jpg'))
                ...
                <div class="col-md-12 col-md-offset-0">
                    <div class="card-body">
                        @if ($post->user && auth()->user()->id == $post->user_id)
                            <a href ='/communitypost/{{$post->id}}/edit' class='btn btn-default'>Bericht bewerken ></a>
                        @endif
                        @if ($post->user && auth()->user()->rol == 0||(auth()->user()->id == $post->user_id))
                            {!!Form::open(['action' => ['ResourceController@destroy', $post->id], 'method' => 'POST', 'class' => 'pull-right'])!!}
